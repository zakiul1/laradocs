...
@section('content')
    <div class="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <form id="customerForm" x-data="customerForm()" x-on:submit.prevent="submit"
            action="{{ route('admin.customers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="shipping_address" rows="4"
                            class="w-full rounded-2xl border border-gray-300 dark:border-gray-700 bg-white/90 dark:bg-gray-800 px-4 py-2">{{ old('shipping_address') }}</textarea>
            ...
            <div class="flex justify-end">
                <button type="submit"
                    ...
                    <svg x-show="false" class="animate-spin h-5 w-5" viewBox="0 0 24 24" fill="none"></svg>
                    <span>Create</span>
                </button>
            </div>
                    ...
                    submit() {
                        ...
                        xhr.onload = () => {
                            ...
                            if (xhr.status >= 200 && xhr.status < 300) {
                                ...
                                window.safeToast?.('success', res.message ?? 'Customer created');
