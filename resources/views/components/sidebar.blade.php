...
<nav x-data="{
    ...
    class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 dark:bg-gray-900 dark:border-gray-800 flex flex-col transition-all duration-200">
    <!-- Logo / Header -->
    ...
    <div class="flex-1 overflow-y-auto py-4">
        <ul class="space-y-1 px-3">
            ...
            @if ($isSuper)
                <div class="mt-6">
                    <p class="px-3 text-[10px] uppercase tracking-widest text-gray-400" x-show="sidebarOpen">people</p>
...
<!-- Overlay for mobile (show when sidebar is open, hidden on lg) -->
